...
public class LiverModelRenderer implements GLSurfaceView.Renderer{
    ...
    public LiverModelRenderer(Context context){
        this.context = context;
    }

    public LiverModelRenderer(Context context, List<LiverModel> liverList){
        this.context = context;
